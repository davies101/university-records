<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM lecs WHERE status = 'Lecturer'");
...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/current_Lecturer.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Current Lecturers</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Current lecturer</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM lecs WHERE status = 'lecturer' ORDER BY id ASC");
