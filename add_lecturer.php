...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item"><a href="../dashboard/former_Lecturer.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Fomer Lecturers</a></li>
			<?php if($usertype == "Admin"){ ?>
				<li class="nav-item current"><a href="../dashboard/add_Lecturer.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>Add Lecturer</a></li>
	...
	<section class="contentSection right clearfix">
		...
		<div class="container">
			<div class="wrapper add_employee clearfix">
				<div class="section_title">Add Lecturer</div>
				<form id="addempLecturer" class="clearfix" method="" action="">
					<div class="section_subtitle">Personal Data</div>
					<div class="input-box input-small left">
						<label for="employee_id">Lecturer ID</label><br>
						<input type="text" class="inputField emp_id" placeholder="Optional" name="lecturer_id">
					...
					<div class="input-box input-small right">
						<label for="jobtype">Lectures</label><br>
					...
					<div class="input-box input-small right">
						...
						<select class="inputField empstatus" name="empstatus">
							...
							<option value="former">Former Lecturer</option>
					...
					<div class="section_subtitle left">Upload Lecturer Photo</div>
					<div class="input-box input-upload-box left">
						<div class="upload-wrapper">
							<div class="upload-box">
								<input type="file" name="passport_photo" class="uploadField passport_photo">
								<div class="uploadfile passportPhoto_file">Upload Lecturer Photo</div>
					...
					<div class="section_subtitle left">Upload lecturer ID</div>
					<div class="input-box input-small left">
					...
					<div class="input-box input-small right">
						<label for="relationship">Relationship to Lecturer</label><br>
