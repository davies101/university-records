<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM lecs LIMIT $limit");
...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			<li class="nav-item current"><a href="../dashboard"><span class="nav-icon"><i class="fa fa-users"></i></span>All Lecturers</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper Lecturer_list clearfix">
				<div class="section_title">All Lecturers</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM lecs ORDER BY id ASC LIMIT $limit");
					$getempcount = mysqli_num_rows($getemp);
				?>
				<ul class="emp_list">
					<li class="emp_list_head">
						<div class="emp_item_head emp_id">Lecturer ID</div>
					...
					<div id="displayempList">
						<?php
							if($getempcount >= 1 ){
								...
								echo '<li class="Leturer_item"> No Lecturers record found </li>';
							}
						?>
					</div>
				</ul>
