<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM lecs WHERE status = 'former'");
...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/former_Lecturer.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Former Lecturers</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Former Lecturers</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM lecs WHERE status = 'former' ORDER BY id ASC");
