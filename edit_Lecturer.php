<?php
    ...
    if(isset($_GET['id'])){
    	...
    	$getinfo = mysqli_query($db_connect, "SELECT * FROM lecs WHERE id = '$record_id' ");
        ...
        if($getinfocount == 1){
            if($fetch = mysqli_fetch_assoc($getinfo)){
                ...
                $phone = $fetch['phone'];
                $lecturer_image = $fetch['Lecturer_image'];
	...
	<section class="contentSection right clearfix">
		...
		<div class="container">
			<div class="wrapper add_employee clearfix">
				<div class="section_title">Update Lecturer Records</div>
				<form id="editemployee" class="clearfix" method="" action="">
					...
					<div class="input-box input-small left">
						...
						<input type="text" class="inputField emp_id" placeholder="Optional" name="Lecturer_id" value="<?php echo $Lecturer_id ?>">
						<div class="error Lectureriderror"></div>
					</div>
